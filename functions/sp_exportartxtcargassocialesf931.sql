...
BEGIN	
	...
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo + tit.importeNoRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ','), 12) AS RemuneracionTotal,
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ','), 12) AS RemuneracionImponible1,
	...
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ','), 12) AS RemuneracionImponible2,
	...
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo - tcsac.importeSueldoAnualComplementario - tche.importeHorasExtras - tcv.importeVacaciones,2), 0.00)::VARCHAR, '.', ','), 12) AS SueldoMasAdicionales,
	...
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ','), 12) AS RemuneracionImponible8,
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ',') , 12) AS RemuneracionImponible7,
	...
	RIGHT(C_ZEROS || REPLACE(coalesce(round(tit.importeRemunerativo + tit.importeNoRemunerativo - tit.importeDescuento,2), 0.00)::VARCHAR, '.', ','), 12) AS RemuneracionImponible9,
