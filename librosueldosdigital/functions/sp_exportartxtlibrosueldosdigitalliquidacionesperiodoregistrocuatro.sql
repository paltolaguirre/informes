...
BEGIN	
	...
	LEFT(coalesce(cond.Codigo,'') || C_ESPACIOS, 2) AS CodigoCondicion,
	RIGHT(C_ZEROS || coalesce(actividad,''), 3) AS CodigoActividad, 
	LEFT(coalesce(mc.Codigo,'') || C_ESPACIOS , 3) AS CodigoModalidadContratacion,
	LEFT(coalesce(cs.Codigo,'') || C_ESPACIOS, 2) AS CodigoSiniestrado,
